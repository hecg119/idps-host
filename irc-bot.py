...
channel = "#croissants"
botnick = "idps-h-" + str(random.randint(1, 100000000))
port = 7070
wait = 10
  ...
  try:
    while True:
      ...
      if text.find( "REPLACE_AUTOUPDATE" ) != -1:
        if nick in administrators:
          os.system("cd /tmp && wget https://github.com/samiux/update-croissants/raw/master/auto/idps-host/autoupdate.tar.gz -O /tmp/autoupdate.tar.gz \
